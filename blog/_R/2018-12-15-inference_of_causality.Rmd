...
```{r, fig.width=4, fig.height=4, message=FALSE, out.height=250, out.width=250}
library(bnlearn)
...
```{r, fig.width=4, fig.height=4, out.height=250, out.width=250}
library(parallel)
...
## `pcalg` package
```{r, fig.width=4, fig.height=4, out.height=250, out.width=250, message=FALSE}
library(pcalg)
