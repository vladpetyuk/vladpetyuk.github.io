...
```{r forward_solution_example, message=FALSE, warning=FALSE, fig.width=7.5, fig.height=6}
library(deSolve)
library(rootSolve)
library(ggplot2)
library(dplyr)
...
```{r screen_for_bistability, message=FALSE, warning=FALSE, fig.width=7.5, fig.height=6}
...
```{r demo_of_the_switch, message=FALSE, warning=FALSE, fig.width=7.5, fig.height=6}
pars['S'] <- 1.057
...
```{r demo_of_the_switch2, message=FALSE, warning=FALSE, fig.width=7.5, fig.height=6}
